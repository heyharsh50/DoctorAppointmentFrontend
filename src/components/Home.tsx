      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-blue-700 overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-blue-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  ...
                  We make it easy to connect with healthcare professionals who care.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            ...
            src="https://images.unsplash.com/photo-1551076805-e1869033e561?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1920&q=80"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              We provide the best healthcare services with top medical professionals
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="p-6 bg-blue-50 rounded-lg">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Verified Doctors</h3>
            ...
            <div className="p-6 bg-blue-50 rounded-lg">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Instant Booking</h3>
              <p className="mt-2 text-gray-600">
            ...
            <div className="p-6 bg-blue-50 rounded-lg">
              ...
              <p className="mt-2 text-gray-600">
                Get support anytime through our dedicated support team
              </p>
            </div>
          </div>
        </div>
